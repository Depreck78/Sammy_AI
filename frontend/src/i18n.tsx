...
const es: Dict = {
  ...
  "Choose which folders Sammy may read and write, and where it saves files it creates.":
    "Elige qué carpetas puede leer y escribir Sammy, y dónde guarda los archivos que crea.",
  "Allow access to Desktop": "Permitir acceso al Escritorio",
  "Allow access to Documents": "Permitir acceso a Documentos",
  "Allow access to Downloads": "Permitir acceso a Descargas",
  "Save Sammy's documents in": "Guardar los documentos de Sammy en",
  "No folder chosen (defaults to the Sammy app folder)": "Sin carpeta elegida (usa la carpeta de la app Sammy)",
  "Choose…": "Elegir…",
  Clear: "Borrar",
  "Sammy saves files it creates here unless you tell it another folder.":
    "Sammy guarda aquí los archivos que crea, salvo que le indiques otra carpeta.",
...
const zh: Dict = {
  ...
  "Choose which folders Sammy may read and write, and where it saves files it creates.":
    "选择 Sammy 可读写的文件夹，以及它创建文件的保存位置。",
  "Allow access to Desktop": "允许访问桌面",
  "Allow access to Documents": "允许访问文稿",
  "Allow access to Downloads": "允许访问下载",
  "Save Sammy's documents in": "将 Sammy 的文档保存到",
  "No folder chosen (defaults to the Sammy app folder)": "未选择文件夹（默认使用 Sammy 应用文件夹）",
  "Choose…": "选择…",
  Clear: "清除",
  "Sammy saves files it creates here unless you tell it another folder.":
    "除非你指定其他文件夹，Sammy 会把创建的文件保存在这里。",
  "Let your phone reach Sammy on your network. Stays on across restarts.":
